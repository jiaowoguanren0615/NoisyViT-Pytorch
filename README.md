<h1 align='center'>NoisyViT</h1>

# [NoisyNN: Exploring the Influence of Information Entropy Change in Learning Systems](https://arxiv.org/pdf/2309.10625v2.pdf)
This is a warehouse for NoisyViT-Pytorch-model, can be used to train your image-datasets for vision tasks.   
The code mainly comes from [here](https://github.com/kytimmylai/NoisyNN-PyTorch).  
...
├── models: NoisyViT Model
    ├── build_models.py: Construct NoisyViT models
    ├── vit.py: Construct vision-transformer models
├── util:
...
@article{yu2023exploring,
  title={Exploring the Influence of Information Entropy Change in Learning Systems},
  author={Yu, Xiaowei and Xue, Yao and Zhang, Lu and Wang, Li and Liu, Tianming and Zhu, Dajiang},
