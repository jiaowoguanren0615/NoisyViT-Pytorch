...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'NoisyViT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='NoisyViT_base_patch16_224', type=str, metavar='MODEL',
                        choices=['NoisyViT_large_patch16_224', 'NoisyViT_base_patch16_224',
                                'NoisyViT_base_patch32_224', 'NoisyViT_base_patch16_224_in21k',
                                'NoisyViT_large_patch16_224_in21k', 'NoisyViT_huge_patch14_224_in21k',
                                'NoisyViT_base_patch32_224_in21k', 'NoisyViT_large_patch32_224_in21k'
                                 ],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'NoisyViT training and evaluation script', parents=[get_args_parser()])
